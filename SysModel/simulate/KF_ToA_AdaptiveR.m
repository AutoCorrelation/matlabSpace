    ...
    for num = 1:num_sample
        ...
        switch num
            case 1
                ...
                velocity_var100 = [0;0];
            case 2
                prev_est_state_var001 = AdaptiveR_est_state.var001(:,iter,num-1);
                est_covariance.var001(:,:,iter,num) = est_covariance.var001(:,:,iter,num-1);
                AdaptiveR_est_state.var001(:,iter,num) = LSE.var001(:,iter,num);
                velocity_var001 = (AdaptiveR_est_state.var001(:,iter,num) - prev_est_state_var001)./dt;
 
                prev_est_state_var01 = AdaptiveR_est_state.var01(:,iter,num-1);
                est_covariance.var01(:,:,iter,num) = est_covariance.var01(:,:,iter,num-1);
                AdaptiveR_est_state.var01(:,iter,num) = LSE.var01(:,iter,num);
                velocity_var01 = (AdaptiveR_est_state.var01(:,iter,num) - prev_est_state_var01)./dt;

                prev_est_state_var1 = AdaptiveR_est_state.var1(:,iter,num-1);
                est_covariance.var1(:,:,iter,num) = est_covariance.var1(:,:,iter,num-1);
                AdaptiveR_est_state.var1(:,iter,num) = LSE.var1(:,iter,num);
                velocity_var1 = (AdaptiveR_est_state.var1(:,iter,num) - prev_est_state_var1)./dt;

                prev_est_state_var10 = AdaptiveR_est_state.var10(:,iter,num-1);
                est_covariance.var10(:,:,iter,num) = est_covariance.var10(:,:,iter,num-1);
                AdaptiveR_est_state.var10(:,iter,num) = LSE.var10(:,iter,num);
                velocity_var10 = (AdaptiveR_est_state.var10(:,iter,num) - prev_est_state_var10)./dt;

                prev_est_state_var100 = AdaptiveR_est_state.var100(:,iter,num-1);
                est_covariance.var100(:,:,iter,num) = est_covariance.var100(:,:,iter,num-1);
                AdaptiveR_est_state.var100(:,iter,num) = LSE.var100(:,iter,num);
                velocity_var100 = (AdaptiveR_est_state.var100(:,iter,num) - prev_est_state_var100)./dt;
            case 3
                prev_est_state_var001 = AdaptiveR_est_state.var001(:,iter,num-1);
                est_covariance.var001(:,:,iter,num) = est_covariance.var001(:,:,iter,num-1);
                AdaptiveR_est_state.var001(:,iter,num) = LSE.var001(:,iter,num);
