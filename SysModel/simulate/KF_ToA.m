...
KalmanGain = struct('var001', zeros(2,2,iteration,num_sample),...
    'var01', zeros(2,2,iteration,num_sample),...
    'var1', zeros(2,2,iteration,num_sample),...
    'var10', zeros(2,2,iteration,num_sample),...
    'var100', zeros(2,2,iteration,num_sample)...
    ...
    for num = 1:num_sample
        ...
        switch num
            case 1
                ...
                est_covariance.var001(:,:,iter,num) = 0;
                velocity_var001 = [0;0];

                est_state.var01(:,iter,num) = [0;0];
                est_covariance.var01(:,:,iter,num) = 0;
                velocity_var01 = [0;0];

                est_state.var1(:,iter,num) = [0;0];
                est_covariance.var1(:,:,iter,num) = 0;
                velocity_var1 = [0;0];

                est_state.var10(:,iter,num) = [0;0];
                est_covariance.var10(:,:,iter,num) = 0;
                velocity_var10 = [0;0];

                est_state.var100(:,iter,num) = [0;0];
                est_covariance.var100(:,:,iter,num) = 0;
                velocity_var100 = [0;0];
            case 2
            ...
            otherwise
                ...
                [est_state_var001, est_covariance_var001, kalman_gain_001] = kalmanFilter(prev_est_state_var001,prev_estimate_cov_001,velocity_var001,Q.var001,P.var001,LSE.var001(:,iter,num),meanSysnoise.var001);
                ...
                [est_state_var01, est_covariance_var01, kalman_gain_01] = kalmanFilter(prev_est_state_var01,prev_estimate_cov_001,velocity_var01,Q.var01,P.var01,LSE.var01(:,iter,num),meanSysnoise.var01);
                ...
                [est_state_var1, est_covariance_var1, kalman_gain_1] = kalmanFilter(prev_est_state_var1,prev_estimate_cov_001,velocity_var1,Q.var1,P.var1,LSE.var1(:,iter,num),meanSysnoise.var1);
                ...
                [est_state_var10, est_covariance_var10, kalman_gain_10] = kalmanFilter(prev_est_state_var10,prev_estimate_cov_001,velocity_var10,Q.var10,P.var10,LSE.var10(:,iter,num),meanSysnoise.var10);
                ...
                [est_state_var100, est_covariance_var100, kalman_gain_100] = kalmanFilter(prev_est_state_var100,prev_estimate_cov_001,velocity_var100,Q.var100,P.var100,LSE.var100(:,iter,num),meanSysnoise.var100);
