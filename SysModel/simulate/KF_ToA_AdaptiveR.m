...
AdaptiveQ_est_state = struct('var001', zeros(2,iteration,num_sample),...
...
AdaptiveQ_est_covariance = struct('var001', zeros(2,2,iteration,num_sample),...
...
for iter = 1:iteration
    for num = 1:num_sample
        ...
        switch num
            case 1
                AdaptiveQ_est_state.var001(:,iter,num) = [0;0];
                AdaptiveQ_est_covariance.var001(:,:,iter,num) = P.var001;
                velocity_var001 = [0;0];

                AdaptiveQ_est_state.var01(:,iter,num) = [0;0];
                AdaptiveQ_est_covariance.var01(:,:,iter,num) = P.var01;
                velocity_var01 = [0;0];

                AdaptiveQ_est_state.var1(:,iter,num) = [0;0];
                AdaptiveQ_est_covariance.var1(:,:,iter,num) = P.var1;
                velocity_var1 = [0;0];

                AdaptiveQ_est_state.var10(:,iter,num) = [0;0];
                AdaptiveQ_est_covariance.var10(:,:,iter,num) = P.var10;
                velocity_var10 = [0;0];

                AdaptiveQ_est_state.var100(:,iter,num) = [0;0];
                AdaptiveQ_est_covariance.var100(:,:,iter,num) = P.var100;
                velocity_var100 = [0;0];
            case 2
                prev_est_state_var001 = AdaptiveQ_est_state.var001(:,iter,num-1);
                AdaptiveQ_est_covariance.var001(:,:,iter,num) = AdaptiveQ_est_covariance.var001(:,:,iter,num-1);
                AdaptiveQ_est_state.var001(:,iter,num) = LSE.var001(:,iter,num);
                velocity_var001 = (AdaptiveQ_est_state.var001(:,iter,num) - prev_est_state_var001)./dt;

                prev_est_state_var01 = AdaptiveQ_est_state.var01(:,iter,num-1);
                AdaptiveQ_est_covariance.var01(:,:,iter,num) = AdaptiveQ_est_covariance.var01(:,:,iter,num-1);
                AdaptiveQ_est_state.var01(:,iter,num) = LSE.var01(:,iter,num);
                ...
                AdaptiveQ_est_covariance.var1(:,:,iter,num) = AdaptiveQ_est_covariance.var1(:,:,iter,num-1);
                AdaptiveQ_est_state.var1(:,iter,num) = LSE.var1(:,iter,num);
                ...
                AdaptiveQ_est_covariance.var10(:,:,iter,num) = AdaptiveQ_est_covariance.var10(:,:,iter,num-1);
                AdaptiveQ_est_state.var10(:,iter,num) = LSE.var10(:,iter,num);
                ...
                AdaptiveQ_est_covariance.var100(:,:,iter,num) = AdaptiveQ_est_covariance.var100(:,:,iter,num-1);
                AdaptiveQ_est_state.var100(:,iter,num) = LSE.var100(:,iter,num);
            ...
            otherwise
                prev_est_state_var001 = AdaptiveQ_est_state.var001(:,iter,num-1);
                prev_estimate_cov_001 = AdaptiveQ_est_covariance.var001(:,:,iter,num-1);
                [est_state_var001, est_covariance_var001, kalman_gain_001] = kalmanFilter(prev_est_state_var001,prev_estimate_cov_001,velocity_var001,Q.var001,Rmean.var001(:,:,1,num),Z.var001(:,1,iter,num),meanSysnoise.var001);
                AdaptiveQ_est_state.var001(:,iter,num) = est_state_var001;
                AdaptiveQ_est_covariance.var001(:,:,iter,num) = est_covariance_var001;
                velocity_var001 = (AdaptiveQ_est_state.var001(:,iter,num) - prev_est_state_var001)./dt;
                KalmanGain.var001(:,:,iter,num) = kalman_gain_001;

                prev_est_state_var01 = AdaptiveQ_est_state.var01(:,iter,num-1);
                prev_estimate_cov_01 = AdaptiveQ_est_covariance.var01(:,:,iter,num-1);
                ...
                AdaptiveQ_est_covariance.var01(:,:,iter,num) = est_covariance_var01;
                velocity_var01 = (AdaptiveQ_est_state.var01(:,iter,num) - prev_est_state_var01)./dt;
                KalmanGain.var01(:,:,iter,num) = kalman_gain_01;

                prev_est_state_var1 = AdaptiveQ_est_state.var1(:,iter,num-1);
                prev_estimate_cov_1 = AdaptiveQ_est_covariance.var1(:,:,iter,num-1);
                ...
                AdaptiveQ_est_covariance.var1(:,:,iter,num) = est_covariance_var1;
                velocity_var1 = (AdaptiveQ_est_state.var1(:,iter,num) - prev_est_state_var1)./dt;
                KalmanGain.var1(:,:,iter,num) = kalman_gain_1;

                prev_est_state_var10 = AdaptiveQ_est_state.var10(:,iter,num-1);
                prev_estimate_cov_10 = AdaptiveQ_est_covariance.var10(:,:,iter,num-1);
                ...
                AdaptiveQ_est_covariance.var10(:,:,iter,num) = est_covariance_var10;
                velocity_var10 = (AdaptiveQ_est_state.var10(:,iter,num) - prev_est_state_var10)./dt;
                KalmanGain.var10(:,:,iter,num) = kalman_gain_10;

                prev_est_state_var100 = AdaptiveQ_est_state.var100(:,iter,num-1);
                prev_estimate_cov_100 = AdaptiveQ_est_covariance.var100(:,:,iter,num-1);
                ...
                AdaptiveQ_est_covariance.var100(:,:,iter,num) = est_covariance_var100;
                velocity_var100 = (AdaptiveQ_est_state.var100(:,iter,num) - prev_est_state_var100)./dt;
