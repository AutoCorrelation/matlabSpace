function [estimate_state,estimate_covariance,kalman_gain] = kalmanFilter(prev_estimate_state,prev_estimate_cov,prev_velocity,Q,R,measurement)
    % Kalman Filter
    ...
    % predict
    % predict_state = F * prev_estimate_state;
    estimate_state = F * prev_estimate_state + prev_velocity*dt;
    % predict_covariance = F * prev_predict_cov * F' + Q;
